  ...
  return (
   ...
   {zadaci.length > 0 &&
    ...
    <><div className="ispit-trajanje ml-[2%] w-[96%] pl-2 pr-2">
      ...
      {/* .........inputi i outputi......... */}
      <h1 className="mt-10 text-2xl text-[#000000] font-bold w-[96%] pl-2 pr-2 m-auto">Examples</h1>
      <div className="primjeriInputa w-[96%] pl-2 pr-2 ">
        ...
        <h1 className="mt-10 text-2xl text-[#000000] font-bold w-[96%] pl-2 pr-2 m-auto">Hidden examples</h1>
        <div className="primjeriInputa w-[96%] pl-2 pr-2 ">
